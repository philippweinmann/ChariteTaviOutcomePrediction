...
import matplotlib.pyplot as plt
# %%
def get_metadata_dataset(patients):
    metadatas = [] # series
    optimal_outcomes = []
    ...
    for patient in patients:
        ...
        metadata = patient.metadata_series
...
# %%
X, y = get_metadata_dataset(patients)
# %%
# 2. define model
...
def get_aggregated_classification_report():
